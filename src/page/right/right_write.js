...
import '../main.css';
import category from '../left/category';
...
class right_write extends Component {
  ...
  render() {
    const {category, _selectCategoryData, select_category, _getModifyData} = this.props;

    return (
        <div>
          <div className='select_category_div'>
            <select name='select_category' onChange={() => _selectCategoryData()} value={select_category}
            >
