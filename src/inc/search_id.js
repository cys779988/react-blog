...
class search_id extends Component {
    ...
    _searchUserID = async function() {
        ...
        const user_birthday = document.getElementsByName('search_id_birthday')[0].value.trim();
        ...
        return(
            <div>
                ...
                <div className='Search_div'>
                    ...
                    <div>
                    <input type='button' value='조회하기' name='search_id_submit' onClick={() => this._searchUserID()}/>
                    </div>
                </div>
                : 
                <div>
